...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $pendingCount = Transaction::where('transaction_type', '!=', 'qr')->where('status', 'pending')->count();
        $approvedCount = Transaction::where('transaction_type', '!=', 'qr')->where('status', 'approved')->count();
        $completedCount = Transaction::where('transaction_type', '!=', 'qr')->where('status', 'completed')->count();
        $rejectedCount = Transaction::where('transaction_type', '!=', 'qr')->where('status', 'rejected')->count();
