<div class="sidebar" data-color="white" data-active-color="danger">
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li
            class="{{ ($activeSection ?? 'false') == 'product' || ($activeSection ?? 'false') == 'products' ? 'active' : '' }}">
            <a href="{{ route('admin.products') }}">
                <i class="fa-brands fa-product-hunt"></i>
                <span class="sidebar-normal" style="font-weight: 600;">{{ __('Product') }}</span>
            </a>
            </li>
           <li
                class="{{ ($activeSection ?? 'false') == 'points' || ($activeSection ?? 'false') == 'user-points' ? 'active' : '' }}">
                <a href="{{ route('admin.users.points') }}">
                    <i class="fa-brands fa-product-hunt"></i>
                    <span class="sidebar-normal" style="font-weight: 600;">{{ __('User Product Points') }}</span>
                </a>
            </li>
            <li
