                    ...
                    <td>
                        @if (isset($qrs[$index]))
                            <div class="qr-item">
                                ...
                                <div class="qr-points">
                                  {{ $qrs[$index]->qr_type === 'gift' ? 'MJP' : ($qrs[$index]->qr_type === 'product' && isset($qrs[$index]->product->name) && $qrs[$index]->product->name !== ''
                                  ? 'MJP-' . \Illuminate\Support\Str::limit($qrs[$index]->product->name, 10, '...') : $qrs[$index]->points . ' POINTS') }}
                                </div>
